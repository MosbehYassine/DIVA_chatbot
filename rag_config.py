...
CHUNK_STRATEGY = os.getenv("RAG_CHUNK_STRATEGY", "html").lower()
...
# Retrieval
RETRIEVAL_POOL_SIZE = int(os.getenv("RAG_RETRIEVAL_POOL", "30"))
RERANK_LEXICAL_WEIGHT = float(os.getenv("RAG_RERANK_LEX_WEIGHT", "0.45"))
RERANK_VECTOR_WEIGHT = float(os.getenv("RAG_RERANK_VEC_WEIGHT", "0.55"))
...
RERANK_EMBEDDING_WEIGHT = float(os.getenv("RAG_RERANK_EMB_WEIGHT", "0.25"))
